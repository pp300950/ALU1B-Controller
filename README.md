...
-   **ผลลัพธ์ที่แสดง:**
    ...
    ----------------------------------------
    ```
    *สังเกตว่า B เป็น 0 แต่ไม่ถูกนำมาคำนวณ และผลลัพธ์คือค่าที่กลับกันของ A ส่วน B ไม่ถูกนำมาคำนวณด้วย*
---
...
-   **ผลลัพธ์ไม่ถูกต้อง**:
    -   ตรวจสอบการเดินสายไฟระหว่าง Arduino
...
int i = 1; //ประกาศพร้อมกับค่าเดียวกับใน for loop
int fact = 1;
